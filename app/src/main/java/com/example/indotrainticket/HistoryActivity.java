...
import com.example.indotrainticket.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking tiket kereta untuk melakukan perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + ". " +
